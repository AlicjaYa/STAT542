...
log_filepath = '/data0/jinhaibo/Remote/STAT/logs/ResNet50-dataaug'
...
#    x = BatchNormalization(momentum=0.9, epsilon=1e-5)(x)
    ...
    # input: 64 output: 10
    x = Dense(classes_num, activation='softmax', kernel_initializer="he_normal")(x)
#              kernel_regularizer=regularizers.l2(weight_decay))(x)
    return x
...
resnet.fit(x_train, y_train, batch_size=batch_size,
                     ...
                     validation_data=(x_test, y_test))
'''
resnet.save('/data0/jinhaibo/Remote/STAT/models/resnet50-dataaug.h5')
